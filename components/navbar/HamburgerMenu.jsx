...
const HamburgerMenu = () => {
  ...
  return (
    <header className={`max-[900px]:block hidden px-4 py-2 bg-white`}>
        ...
        isSidebarVisible ? "translate-x-0" : "-translate-x-full"
          ...
          >
            <div className="flex flex-col w-64 bg-white h-full">
              ...
              <div className="flex flex-col flex-1 overflow-y-auto h-full text-[15px] justify-start items-center">
