...
const Navbar = () => {
  return (
    <>
      <header className="container hidden min-[900px]:block bg-white text-white font-inter bg-opacity-80 h-[105px]">
        <div className="mx-auto py-5 w-full max-w-[1336px] justify-center flex flex-nowrap flex-col md:flex-row items-center">
          <Link href={"/"}>
