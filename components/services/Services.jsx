...
const Services = () => {
  return (
    <ContentWrapper
      className={`flex justify-center items-center md:mt-28 lg:mt-36 flex-col font-poppins`}
    >
      <div className="space-y-4">
        <p className="text-center text-lg font-normal">
          and we go beyond just visuals…
        </p>
        <h1 className="md:text-[40px] lg:text-[46px] font-recoleta italic font-black text-center">
      ...
      <div className="flex justify-center items-center">
        <div className="mt-[46px] grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-[44px] w-full max-w-[1159px] ">
